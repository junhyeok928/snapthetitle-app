                ...
                <div className="flex container px-3 pb-5 mx-auto">
                    <div className="xl:w-full lg:w-full w-full mx-auto mt-3 ">
                        ...
                        <p className="leading-relaxed text-md">
                            매 순간이 하나의 장면이고, 그 장면마다 고유한 제목이 있다고 믿습니다.
                        </p>
                        <p className="leading-relaxed text-md">
                            결혼은 그런 장면들로 채워진, 두 사람만의 영화입니다.
                        </p>
                        <br/>
                        <p className="leading-relaxed text-md">
                        ...
                        <p className="leading-relaxed text-md">
                            그래서 제 촬영은 두 분이 사랑에 빠지는 것부터 시작됩니다.
                        </p>
                        <p className="leading-relaxed text-md">
                            시선에 애정을 가득 담아,
                        </p>
                        <p className="leading-relaxed text-md">
                            각 커플이 지닌 고유한 무드를 기록하고,
                        </p>
                        <p className="leading-relaxed text-md">
                            시간이 흘러도 다시 그 순간이 느껴지는 사진을 남기겠습니다.
                        </p>
